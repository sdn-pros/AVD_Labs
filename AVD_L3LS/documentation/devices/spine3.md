...
| Ethernet8 | P2P_LINK_TO_BORDERLEAF2_Ethernet5 | routed | - | 192.168.203.20/31 | default | 1500 | False | - | - |
...
| 192.168.203.9 | 65299 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.203.13 | 65299 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.203.21 | 65298 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
router bgp 65002
   ...
   neighbor 192.168.203.9 remote-as 65299
   neighbor 192.168.203.9 description leaf3_Ethernet5
   neighbor 192.168.203.13 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.13 remote-as 65299
   neighbor 192.168.203.13 description leaf4_Ethernet5
   neighbor 192.168.203.21 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.21 remote-as 65298

...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet5 | P2P_LINK_TO_SPINE3_Ethernet6 | routed | - | 192.168.203.13/31 | default | 1500 | False | - | - |
| Ethernet6 | P2P_LINK_TO_SPINE4_Ethernet6 | routed | - | 192.168.203.15/31 | default | 1500 | False | - | - |
...
router bgp 65299
   ...
   neighbor 192.168.203.12 description spine3_Ethernet6
   neighbor 192.168.203.14 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.14 remote-as 65002
   neighbor 192.168.203.14 description spine4_Ethernet6
